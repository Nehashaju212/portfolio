...
const ProjectsSection = () => {
  ...
  const projects = [
    {
      ...
      description:
        "A collection of visually engaging posters designed for promotions, announcements, and awareness campaigns, each tailored to effectively communicate key messages through impactful design and typography.",
    ...
    },
    {
      ...
      description:
        "A comprehensive redesign of the Inflow.chat platform focusing on intuitive navigation, modern aesthetics, and calming visuals to enhance user engagement and communication flow.",
    ...
    },
    {
      ...
      description:
        "A real-time sign language translator that converts hand gestures into speech using OpenCV and TensorFlow, empowering the speech-impaired community with better communication tools.",
    ...
    },
    {
      ...
      description:
        "An advanced machine learning model that analyzes transaction patterns to detect fraudulent credit card activity, enhancing financial security through data-driven insights and predictive analytics.",
  ...
  return (
    <>
      ...
      <section id="projects" className="projects-section section" ref={sectionRef} aria-labelledby="projects-heading">
              ...
              >
                  ...
                  <div className="project-overlay">
                    <div className="project-tags" role="list" aria-label="Project technologies">
                      {project.tags.map((tag, tagIndex) => (
                        <span key={tagIndex} className="project-tag" role="listitem">
                          {tag}
                        </span>
                      ))}
                    </div>
                ...
                <div className="project-content">
                  <div className="project-meta">
                    <span className="project-category" itemProp="category">
                      {project.category}
                    </span>
                    <span className="project-year" itemProp="dateCreated">
                      {project.year}
                    </span>
                  </div>
